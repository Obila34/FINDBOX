...
export function Landing() {
 ...
 { role: 'Students', title: 'Your world. A little more yours.', image: '/media/products/explorer-4k.png', text: 'Your belongings, daily streaks, and small acts that make a difference.', cls: 'student' },
 { role: 'Parents', title: 'Less worry. More peace of mind.', image: '/media/products/bottle-4k.png', text: 'See your children’s belongings, follow updates, and arrange collection.', cls: 'parent' },
